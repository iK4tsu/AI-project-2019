...
import pt.ipleiria.estg.dei.ia.pl5.g13.warehouse.WarehouseIndividual;
import pt.ipleiria.estg.dei.ia.pl5.g13.warehouse.WarehouseProblemForGA;
import pt.ipleiria.estg.dei.ia.pl5.g13.ga.geneticOperators.*;
import pt.ipleiria.estg.dei.ia.pl5.g13.ga.selectionMethods.SelectionMethod;
import pt.ipleiria.estg.dei.ia.pl5.g13.ga.selectionMethods.Tournament;
...
public class PanelParameters extends PanelAtributesValue {
    ...
    String[] recombinationMethods = {"PMX", "OX1", "OX2", "CX", "POS"};
    ...
    String[] mutationMethods = {"Insert", "Iversion", "Swap"};
    ...
    public Recombination<WarehouseIndividual, WarehouseProblemForGA> getRecombinationMethod() {
        ...
        switch (comboBoxRecombinationMethods.getSelectedIndex()) {
            ...
            case 2:
                return new RecombinationOrderBased<>(recombinationProb);
            case 3:
                return new RecombinationCycle<>(recombinationProb);
            case 4:
                return new RecombinationPositionBased<>(recombinationProb);
        }
        return null;
    }
